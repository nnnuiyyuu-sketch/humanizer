...
- `game/index.html` — «Новария», a browser game unrelated to the skill. Styles and logic live in that one file.
- `game/ui.html` — the game's design system: tokens, components and key screens. Visual changes start here, then move into the game; see `game/README.md`.
